...
import 'package:signally/utils_constants/app_constants.dart';
            ...
            child: Row(
              children: [
                Expanded(
                  child: ZCard(
                    onTap: () {
                      ZLaunchUrl.launchUrl(AppConstants.facebookUrl);
                    },
                ...
                Expanded(
                  child: ZCard(
                    onTap: () {
                      ZLaunchUrl.launchUrl(AppConstants.twitterUrl);
                    },
                    color: Colors.transparent,
                    margin: EdgeInsets.zero,
                    padding: EdgeInsets.zero,
                ...
                Expanded(
                  child: ZCard(
                    onTap: () {
                      ZLaunchUrl.launchUrl(AppConstants.instagramUrl);
                    },
                    color: Colors.transparent,
                    margin: EdgeInsets.zero,
                    padding: EdgeInsets.zero,
