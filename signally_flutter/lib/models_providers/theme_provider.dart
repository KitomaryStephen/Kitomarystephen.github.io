...
class Themes {
  ...
  static ThemeData _baseTheme(ThemeData themeData) {
    ...
    Color scaffoldBackgroundColor = isLightTheme ? Color(0xFFFAFAFC) : Color(0xFF141517);
    ...
    return ThemeData(
      ...
      textTheme: TextTheme(
        bodyText2: themeData.textTheme.bodyText2?.copyWith(fontSize: 12.5),
      ),
      appBarTheme: AppBarTheme(
          ...
          titleTextStyle: TextStyle(color: textColor, fontSize: 22, fontWeight: FontWeight.w600)),
      ...
      cardColor: isLightTheme ? Colors.grey.shade100 : Color(0xFF1F2127),
    );
  }
  ...
  static void setStatusNavigationBarColor() async {
    ...
    Color systemNavigationBarColorDark = Color(0xFF141518);
